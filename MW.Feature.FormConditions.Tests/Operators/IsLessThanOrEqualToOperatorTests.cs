...
{
    [TestClass]
    public class IsLessThanOrEqualToOperatorTests
    {
        private IsLessThanOrEqualToOperator _service;

        [TestInitialize]
        public void Initialize()
        {
            _service = new IsLessThanOrEqualToOperator();
        }
        ...
        [TestMethod]
        public void IsMatchShouldMatchOnSingleEqualInt()
        {
        ...
        [TestMethod]
        public void IsMatchShouldMatchOnSingleEqualDouble()
        {
            Assert.IsTrue(_service.IsMatch(new List<object>() { 1.1D }, 1.1D));
        }
        ...
        [TestMethod]
        public void IsMatchShouldMatchOnSinglEqualDecimal()
        {
            Assert.IsTrue(_service.IsMatch(new List<object>() { 1.1M }, 1.1M));
        }
